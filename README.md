...
## Build
*eprosima xtypes* is header only library, you can simply copy files located in the include folder into your project and include them.

For a better management and version control, we recommend to make use of the **CMake** project that xtypes offers.
Although there is no library generated by from *xtypes*, you can link with its target as following to enable your project to include the *xtypes* headers:
```
