...
public:
    ...
    DynamicData operator - () const;

    DynamicData operator * (const ReadableDynamicDataRef&) const;
    DynamicData operator / (const ReadableDynamicDataRef&) const;
    DynamicData operator % (const ReadableDynamicDataRef&) const;
    DynamicData operator + (const ReadableDynamicDataRef&) const;
    DynamicData operator - (const ReadableDynamicDataRef&) const;
...
DynamicData DynamicData::operator - () const
{
...
DynamicData DynamicData::operator * (const ReadableDynamicDataRef& other) const
{
    switch(type_.kind())
    {
        case TypeKind::INT_8_TYPE:
