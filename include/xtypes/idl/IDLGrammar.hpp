...
SEQUENCE_TYPE <- KW_SEQUENCE OPEN_ANG_BRACKET TYPE_SPEC COLLECTION_SIZE? CLOSE_ANG_BRACKET
...
# XTYPES
MAP_TYPE <- KW_MAP OPEN_ANG_BRACKET TYPE_SPEC COMMA TYPE_SPEC COLLECTION_SIZE? CLOSE_ANG_BRACKET
